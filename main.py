...
from prototype_application import my_first_app, my_first_app_advance, prototype_settings
from pwd_module import password_settings, reset_passwords
    ...
    try:
            ...
            if df is not None:
                ...
                if st.checkbox("Start Predictive Model"):
                    (
                        ...
                        X,
                        Sucess,
                    ) = prepare_data_and_train(df)
                    if Sucess:
                        plot_predictions(
                            df_predict, tree, lr, column_name, future_days, X
                        )
                    else:
                        st.warning(
                            "Please fill in all the fields in the machine learning form"
                        )
        ...
        # ========================Modify the workshop code below this line========================#
            ...
            if "ASSISTANT_ID" in st.secrets or "MAPBOX_TOKEN" in st.secrets:
                ...
                st.warning(
                    "Please enter your Assistant ID and Mapbox Token to enable this feature"
                )
            pass
        ...
        # ========================ZERO CODE workshop code below do not modify========================#
            ...
            st.session_state.option == "Bot & Prompt Management"
